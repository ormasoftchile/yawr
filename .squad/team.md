...
| Name | Role | Scope |
| --- | --- | --- |
| Lead | Product & Runtime Architect | Product boundaries, execution model, architecture, and review |
...
| Rai | RAI Reviewer | Safety and responsible-release checks | active |
| Fact Checker | Verifier | Claims, assumptions, and evidence review | active |

## Principles

1. Fail closed.
2. Minimize blast radius.
3. Prove production paths.
4. Require non-vacuous tests.
5. Keep contracts separate from implementations.
