# Lead — Product & Runtime Architect
...
Product boundaries, execution model, architecture, review.
...
- Coordinate boundaries and reviews without prematurely selecting a language, storage engine, syntax, cloud, UI, or architecture.
...
**I handle:** Product boundaries, execution model, architecture, review.
