...
- **Can:** review code and pull requests; write and modify code; write and run tests; responsible-AI and content-safety review; cut releases and publish packages; author and maintain CI/CD workflows
- **Cannot (no agent claims this):** write and maintain documentation; security and secrets review; UX and visual design; deploy to live environments
